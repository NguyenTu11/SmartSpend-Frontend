...
export function AuthForm({ initialMode = "login" }: AuthFormProps) {
    ...
    const loginErrorMessage = validationError || loginAxiosError?.response?.data?.message || (loginError ? "Đăng nhập thất bại" : "")
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden px-4 pb-8">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <p className="text-gray-400 text-sm mb-4 text-center">Quản lý chi tiêu thông minh cùng với AI</p>
                        ...
                        >
                            <div className="w-1/2 px-1 py-1">
                                ...
                                <p className="mt-4 text-center text-gray-400">
                                    Chưa có tài khoản?{" "}
                                    <button type="button" onClick={switchToRegister} className="text-violet-400 font-medium hover:text-violet-300 transition-colors">
                                        Đăng ký ngay
                                    </button>
                                </p>
                            </div>
                            ...
                            <div className="w-1/2 px-1 py-1">
                                ...
                                <p className="mt-4 text-center text-gray-400">
                                    Đã có tài khoản?{" "}
                                    <button type="button" onClick={switchToLogin} className="text-violet-400 font-medium hover:text-violet-300 transition-colors">
                                        Đăng nhập
                                    </button>
                                </p>
                            </div>
